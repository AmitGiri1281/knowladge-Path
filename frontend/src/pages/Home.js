...
// // Beautiful background images for different sections
// const backgroundImages = {
//   // Hero section backgrounds
//   hero: 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
//   heroOverlay: 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
...
//   technology: 'https://images.unsplash.com/photo-1518770660439-4636190af475?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
//   arts: 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
//   literature: 'https://images.unsplash.com/photo-1474932430478-367dbb6832c1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
//   history: 'https://images.unsplash.com/photo-1461360370896-922624d12aa1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  
//   // Featured backgrounds
//   featured: 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  
//   // AI Assistant background
//   aiAssistant: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  
//   // Newsletter background
//   newsletter: 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80'
// };

// // Fallback gradient colors for each category
...
//   'Literature': 'from-orange-600 to-red-600',
...
//       'Technology': backgroundImages.technology,
//       'Arts': backgroundImages.arts,
//       'Literature': backgroundImages.literature,
//       'History': backgroundImages.history
//     };
//     return bgMap[categoryName] || backgroundImages.hero;
//   };

//   const getCategoryGradient = (categoryName) => {
//     return categoryGradients[categoryName] || 'from-blue-600 to-purple-600';
//   };
...
//             className="text-center text-white max-w-4xl mx-auto"
//           >
//             {/* Platform Name with glass effect */}
//             <motion.div
//               initial={{ scale: 0.9 }}
//               animate={{ scale: 1 }}
//               transition={{ duration: 0.5, delay: 0.2 }}
//               className="inline-flex items-center space-x-2 mb-6 bg-white/10 backdrop-blur-md px-6 py-3 rounded-full"
//             >
//               <div className="bg-gradient-to-r from-yellow-400 to-pink-400 p-2 rounded-full">
//                 <FaGraduationCap className="text-2xl" />
//               </div>
//               <span className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-yellow-300 to-pink-300 bg-clip-text text-transparent">
//                 Knowledge PathWay
//               </span>
//             </motion.div>
...
//             {categories.map((category, index) => {
//               const details = getCategoryDetails(category.name);
//               const bgImage = getCategoryBackground(category.name);
...
//                 >
//                   <Link to={`/category/${category._id}`}>
//                     <div className="relative h-64 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group">
//                       {/* Background Image */}
//                       <div className="absolute inset-0">
//                         <img 
//                           src={bgImage}
...
//                         />
//                         <div className={`absolute inset-0 bg-gradient-to-t ${gradient} opacity-80 group-hover:opacity-90 transition`}></div>
//                       </div>
...
//       {/* Featured Topics with Background Images */}
//       {featuredTopics.length > 0 && (
//         <section className="container mx-auto px-4">
//           <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-8 flex items-center">
//             <FaStar className="mr-3 text-yellow-500" />
...
//               const bgImage = getCategoryBackground(categoryName);
...
//                 >
//                   <Link to={`/content/${topic._id}`}>
//                     <div className="relative h-64 rounded-2xl shadow-lg hover:shadow-xl transition overflow-hidden group">
//                       {/* Background Image */}
//                       <div className="absolute inset-0">
//                         <img 
//                           src={bgImage}
...
//       {/* Recent & Trending (unchanged functionality, added subtle background) */}
//       <section className="container mx-auto px-4">
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
//           {/* Recent Topics */}
//           <motion.div
...
//                   >
//                     <Link to={`/content/${topic._id}`}>
//                       <div className="group flex items-start space-x-4 p-3 hover:bg-green-50 rounded-xl transition">
//                         <div className="bg-green-100 p-3 rounded-lg group-hover:bg-green-600 group-hover:text-white transition">
//                           <FaRegClock className="text-green-600 group-hover:text-white" />
//                         </div>
//                         <div className="flex-1">
...
//                   >
//                     <Link to={`/content/${topic._id}`}>
//                       <div className="group flex items-start space-x-4 p-3 hover:bg-orange-50 rounded-xl transition">
//                         <div className="bg-orange-100 p-3 rounded-lg group-hover:bg-orange-600 group-hover:text-white transition relative">
//                           <FaFire className="text-orange-600 group-hover:text-white" />
//                           {index === 0 && (
//                             <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs w-4 h-4 flex items-center justify-center rounded-full">
...
//       {/* AI Assistant Banner with Background Image */}
//       <section className="container mx-auto px-4">
//         <motion.div
//           initial={{ opacity: 0, y: 20 }}
//           animate={{ opacity: 1, y: 0 }}
...
//           <div className="absolute inset-0">
//             <img 
//               src={backgroundImages.aiAssistant}
//               alt="AI Assistant"
//               className="w-full h-full object-cover"
//             />
//             <div className="absolute inset-0 bg-gradient-to-r from-purple-900/90 via-pink-900/90 to-red-900/90"></div>
//           </div>
...
//       {/* Quick Access Grid with Background Images */}
//       <section className="container mx-auto px-4">
//         <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
//           <FaChartLine className="mr-3 text-blue-600" />
//           Quick Access
...
//                 <motion.div
//                   whileHover={{ y: -5, scale: 1.02 }}
//                   className="relative h-32 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group"
//                 >
//                   {/* Background Image */}
//                   <div className="absolute inset-0">
//                     <img 
...
//             <motion.div
//               whileHover={{ y: -3 }}
//               className="bg-gray-100 rounded-xl p-4 text-center hover:shadow-lg transition group h-32 flex flex-col items-center justify-center"
//             >
//               <div className="w-12 h-12 mx-auto mb-2 rounded-full bg-gray-200 flex items-center justify-center group-hover:scale-110 transition">
//                 <FaArrowRight className="text-gray-600 text-xl" />
//               </div>
...
const backgroundImages = {
  ...
  resources: 'https://images.unsplash.com/photo-1507842217343-583bb7270b66?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  booksBg: 'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  journalsBg: 'https://images.unsplash.com/photo-1586339949916-3e9457bef6d3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  newsBg: 'https://images.unsplash.com/photo-1495020689063-958f8529c560?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  workshopsBg: 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  conferencesBg: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  videosBg: 'https://images.unsplash.com/photo-1579165466991-34f8ad8d7fb2?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
...
const resourcesData = [
  { 
    ...
    bg: backgroundImages.booksBg,
    count: "50+ Resources",
    description: "Free books & digital libraries"
  },
  { 
    name: "Journals", 
    ...
    bg: backgroundImages.journalsBg,
    count: "100+ Journals",
  ...
  { 
    ...
    bg: backgroundImages.workshopsBg,
    count: "25+ Workshops",
  ...
  { 
    ...
    bg: backgroundImages.conferencesBg,
...
<div className="absolute inset-0 bg-gradient-to-r from-black/50 via-black/20 to-transparent"></div>
      ...
      <section className="container mx-auto px-4 -mt-20 relative z-10">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link to="/resources" className="text-green-600 hover:text-green-700 flex items-center group">
            View All Resources <FaArrowRight className="ml-2 group-hover:translate-x-1 transition" />
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
          {resourcesData.map((resource, index) => (
            <motion.div
              ...
              transition={{ duration: 0.4, delay: index * 0.05 }}
              whileHover={{ y: -8 }}
              onHoverStart={() => setActiveResource(resource.name)}
              onHoverEnd={() => setActiveResource(null)}
            >
              <Link to={resource.path}>
                <div className="relative h-48 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                  {/* Background Image */}
                  <div className="absolute inset-0">
                    <img 
                      src={resource.bg}
                      ...
                      className="w-full h-full object-cover group-hover:scale-110 transition duration-700"
                    />
                    <div className={`absolute inset-0 bg-gradient-to-t ${resource.color} opacity-80 group-hover:opacity-90 transition`}></div>
                  </div>
                  
                  {/* Content */}
                  <div className="absolute inset-0 p-4 flex flex-col justify-end text-white">
                    <div className="flex items-center justify-between mb-2">
                      <div className="bg-white/20 backdrop-blur-sm p-2 rounded-xl group-hover:scale-110 transition-transform">
                    ...
                    <div className="flex items-center justify-end text-xs font-medium text-white/90 group-hover:translate-x-1 transition-transform">
                      Explore <FaArrowRight className="ml-1 text-[10px]" />
                    </div>
                  </div>
                </div>
              </Link>
      ...
      <section className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          ...
          {/* Quick Resources */}
          {resourcesData.slice(0, 2).map((resource) => (
              ...
              >
                ...
                <div className="absolute inset-0">
                  <img 
                    ...
                    className="w-full h-full object-cover group-hover:scale-110 transition duration-500"
                  />
                  <div className={`absolute inset-0 bg-gradient-to-t ${resource.color} opacity-70`}></div>
                </div>
      ...
      <section className="container mx-auto px-4">
        ...
        >
          ...
          <div className="absolute inset-0">
            <img 
              src={backgroundImages.resources}
              alt="Resources"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-green-900/90 via-teal-900/90 to-blue-900/90"></div>
          </div>
          ...
          <div className="relative px-8 py-12 text-white">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div>
                <h3 className="text-3xl md:text-4xl font-bold mb-2">Free Learning Resources</h3>
                <p className="text-xl opacity-90 max-w-2xl">
                  Access books, journals, workshops, and more - all free and external
                </p>
                ...
                <div className="flex flex-wrap gap-3 mt-4">
                  {resourcesData.slice(0, 4).map((resource) => (
                    <Link
                      key={resource.name}
                      to={resource.path}
                      className="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm hover:bg-white/30 transition flex items-center space-x-2"
                    >
                      {resource.icon}
              ...
              <Link to="/resources">
                <motion.button 
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="group px-8 py-4 bg-white text-green-600 rounded-xl font-bold text-lg hover:shadow-2xl transition-all flex items-center space-x-2"
                >
          ...
          <div className="absolute bottom-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full filter blur-3xl"></div>
        </motion.div>
      </section>
    </div>
  );
